...
@pytest.fixture
def relos_ann_index(elasticsearch_proc):
    yield elasticsearch_proc.indices.create("relos-ann")
...
@pytest.fixture
def relos_ann_data(ann_index, elasticsearch_proc):
    # case_id, review_action, review_action_time
    data = [
        ("CID_1", "dismiss", "2020-04-02 07:49:02"),
        ("CID_2", "review", "2020-04-04 22:33:40"),
        ("CID_3", "submit", "2020-04-01 07:52:27"),
        ("CID_4", "audit", "2020-04-06 08:43:37"),
        ("CID_5", "submit", "2020-04-02 13:08:41"),
        ("CID_6", "no decision", "2020-04-04 07:49:02"),
        ("CID_7", "review", "2020-04-04 22:33:40"),
        ("CID_8", "review", "2020-04-02 07:52:27"),
        ("CID_9", "no decision", "2020-04-06 08:43:37"),
        ("CID_10", "audit", "2020-04-02 13:08:41")
    ]
    index = Index("relos-ann")
    index.document(al_models.RelosAnn)
    _actions = (
        n.to_dict(True) for n in (
            al_models.RelosAnn(
                case_id=i[0], review_action=i[1],
                review_action_time=tutils.parse_dt(i[2])
            ) for i in data
        ))
    result = helpers.bulk(elasticsearch_proc, _actions)
